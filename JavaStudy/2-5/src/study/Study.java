...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        /*
         * [生成したLinkkedHashMapのインスタンスを、Mapインターフェイス型の変数shopListに保持putメゾットでshopMapの要素を追加し、getメソッドでshohinListの値を取り出している]
         *
         */
        ...
        for(java.util.Map.Entry<String, Integer> entry : shopMap.entrySet()) {
